...
namespace ParaEngine
{
	...
	*/
	...
	{
	public:
		AssetEntity():m_bIsValid(true),m_bIsInitialized(false),m_bIsLocked(false), m_assetState(ASSET_STATE_NORMAL)	{}
		AssetEntity(const AssetKey& key):m_bIsValid(true),m_bIsInitialized(false),m_bIsLocked(false), m_key(key),m_assetState(ASSET_STATE_NORMAL){}
		virtual ~AssetEntity(){};
