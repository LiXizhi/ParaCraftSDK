...
Author(s): LiXizhi
Date: 2014/7/11
Desc: This conforms with the ParaX Model file. This is generally the rule followed by our artist for 
creating buildin model animations. Only a small set of the defined animation may exist in a specific model file.
use the lib:
-------------------------------------------------------
NPL.load("(gl)script/apps/Aries/Creator/Game/Common/AnimTable.lua");
local AnimTable = commonlib.gettable("MyCompany.Aries.Game.Common.AnimTable");
-------------------------------------------------------
]]
local AnimTable = commonlib.createtable("MyCompany.Aries.Game.Common.AnimTable", {
	ANIM_STAND=0,
	ANIM_DEATH=1,
	ANIM_SPELL=2,
	ANIM_STOP=3,
