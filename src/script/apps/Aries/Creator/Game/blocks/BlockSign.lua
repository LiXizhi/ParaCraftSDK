...
local block = commonlib.gettable("MyCompany.Aries.Game.blocks.BlockSign")
-------------------------------------------------------
]]
...
local block = commonlib.inherit(commonlib.gettable("MyCompany.Aries.Game.blocks.BlockEntityBase"), commonlib.gettable("MyCompany.Aries.Game.blocks.BlockSign"));

local side_to_data = {[0] = 1, [1] = 0, [2] = 3, [3] = 2, [4] = 4, [5] = 4, } 

-- register
block_types.RegisterBlockClass("BlockSign", block);
