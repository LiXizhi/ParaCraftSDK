...
local TipAEMenu = commonlib.inherit(CommonCtrl.Motion.AnimativeMenu.AnimativeMenuView, {
	...
	textfont = "System;17;bold", 
	textcolor = "96 96 96 0",
...
function TipAEMenu:BuildMovieClip()
	local mc = CommonCtrl.Motion.AnimativeMenu.TipMenuMovieClip:new({textfont=self.textfont, textcolor=self.textcolor});
	return mc;
end
...
function TipMenuMovieClip:BuildUI()
	...
	_this.font=self.textfont or "System;17;bold";
	_guihelper.SetFontColor(_this, self.textcolor or "96 96 96 0");
	_this.shadow = true;
