...
if(not mathlib.matrix) then mathlib.matrix = {} end
if(not mathlib.complex) then mathlib.complex = {} end
if(not mathlib.fit) then mathlib.fit = {} end
...
-- calculate the square root of a matrix using "Denman朆eavers square root iteration"
