--[[
Title: emulating package model in lua 5.1
Author(s): Copyright Kepler Project 2004-2006 (http://www.keplerproject.org/compat)
Date: 2008/5/1
Desc: Note By LiXizhi: this is never used in ParaEngine, but just kept here for future references
There is also an article talking about the downside of using package model in lua. see http://lua-users.org/wiki/LuaModuleFunctionCritiqued 
I partially implemented this design pattern for MCML inline script code blocks. Please see mcml/pe_script.lua
...
Use Lib:
-------------------------------------------------------
NPL.load("(gl)script/ide/package/moduleEmu.lua");
-------------------------------------------------------
]]
