...
local Item_MountPet_Medal = {};
commonlib.setfield("Map3DSystem.Item.Item_MountPet_Medal", Item_MountPet_Medal)

---------------------------------
-- functions
---------------------------------

function Item_MountPet_Medal:new(o)
...
function Item_MountPet_Medal:OnClick(mouse_button)
